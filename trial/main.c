...
// ATM MACHINE CODE
    ...
    case 3:
        printf("Enter amount to withdraw (e.g. 100.00)\n");
         ...
         {
             Balance1-=Withdraw;
             printf("You've successfully withdrawn GHc%.2f, your current balance is GHc%.2f",Withdraw,Balance1);
         }
         else if (loginaccnum==Account2)
         {
             Balance2-=Withdraw;
             printf("You've successfully withdrawn GHc%.2f, your current balance is GHc%.2f",Withdraw,Balance2);
         }
         goto transaction;
    //TRANSFER
         float Transfer;
         ...
         if (loginaccnum==Account1)
         {
             switch(accnumber)
             {
                 ...
                 case 100002:
                 {
                     Balance2+=Transfer;
                     Balance1-=Transfer;
                     printf("Amount sent to %s succesfully, your account balance is GHc%.2f",User1,Balance2);
                 }
             }
         }
